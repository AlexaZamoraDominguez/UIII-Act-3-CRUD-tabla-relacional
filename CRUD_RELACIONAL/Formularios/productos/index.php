                ...
                <tbody>
                    ...
                    while ($resultado = $sql->fetch_assoc()) {
                        ...
                        <tr>
                            ...
                            <td>
                                <?php echo $resultado['origen']; ?>
                            </td>
                            <td>
                                <?php echo $resultado['transporte']; ?>
                            </td>
                            <td>
                                <?php echo $resultado['ubicacion']; ?>
                            </td>
                            <td>
                                <?php echo $resultado['categoria_p']; ?>
                            </td>
                            <td>
                            ...
                            <td>
                                <a href="<?php echo base_url; ?>Formularios/productos/actualizar.php?id_proveedor=<?php echo $resultado['id_proveedor']; ?>"
                                    class="btn btn-outline-warning">
                                    <i class="fa-solid fa-pen-to-square fa-beat"></i>
                                </a>
                                <a href="<?php echo base_url; ?>CRUDP/eliminarDatos.php?id_proveedor=<?php echo $resultado['id_proveedor']; ?>"
