                ...
                <tbody>
                    ...
                    ?>
                        <tr>
                            ...
                            <td><?php echo $resultado['nombre_p']; ?></td>
                            <td><?php echo $resultado['color']; ?></td>
                            <td><?php echo $resultado['precio']; ?></td>
                            <td><?php echo $resultado['mujer_hombre']; ?></td>
                            <td><?php echo $resultado['talla']; ?></td>
                            <td><?php echo $resultado['cantidad']; ?></td>
                            <td><?php echo $resultado['marca']; ?></td>
                            <td>
                                <a href="<?php echo base_url; ?>Formularios/categorias/actualizar.php?id_producto=<?php echo $resultado['id_producto']; ?>" class="btn btn-outline-warning">
                                    <i class="fa-solid fa-pen-to-square fa-beat"></i>
                                </a>
                                <a href="<?php echo base_url; ?>CRUDC/eliminarDatos.php?id_producto=<?php echo $resultado['id_producto']; ?>" class="btn btn-outline-danger">
